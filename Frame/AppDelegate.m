...
- (void)enterMain{
	self.mainBarController = [[TabBarViewController alloc] initWithNibName:nil bundle:nil];
	self.mainBarController.delegate = self;
	
	UINavigationController *navigatonController = [[UINavigationController alloc] initWithRootViewController:self.mainBarController];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "--.Frame" in the application's documents directory.
